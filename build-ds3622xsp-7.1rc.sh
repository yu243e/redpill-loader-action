...
curl --location https://global.download.synology.com/download/DSM/release/7.1/42621/DSM_DS3622xs%2B_42621.pat --output 42550.pat

sudo LD_LIBRARY_PATH=. ./syno_extract_system_patch 42621.pat output-pat

cd output-pat && sudo tar -zcvf 42621.pat * && sudo chmod 777 42621.pat
read -a os_sha256 <<< $(sha256sum 42621.pat)
echo $os_sha256
cp 42621.pat ${root}/${workpath}/redpill-load/cache/ds3622xsp_42621.pat
cd ../../../
